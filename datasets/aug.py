...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default='/root/autodl-tmp/cv_task_yolov8/datasets_1/JPG')
    parser.add_argument('--source_xml_path', type=str, default='/root/autodl-tmp/cv_task_yolov8/datasets_1/Ano')
    parser.add_argument('--save_img_path', type=str, default='/root/autodl-tmp/cv_task_yolov8/datasets/AddJPEG')
    parser.add_argument('--save_xml_path', type=str, default='/root/autodl-tmp/cv_task_yolov8/datasets/AddAnno')
